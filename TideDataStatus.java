...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_g",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		,  indexes = @Index(name = "tide_idx", columnList = "station_id, parameter_datetime"))
public class TideDataStatus {

	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_g_id",nullable = false)
	private Integer sensorGDataId;
