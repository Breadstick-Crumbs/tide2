...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_e",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})})
public class WaveDataStatus {
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_e_id",nullable = false)
	private Integer sensorWvDataId;
