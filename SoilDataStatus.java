...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_j",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		,  indexes = @Index(name = "soil_idx", columnList = "station_id, parameter_datetime"))
public class SoilDataStatus {

	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_j_id",nullable = false)
	private Integer sensorJDataId;
