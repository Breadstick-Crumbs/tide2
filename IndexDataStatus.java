...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_l",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		, indexes = @Index(name = "index_idx", columnList = "station_id, parameter_datetime"))
public class IndexDataStatus {
	
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_l_id",nullable = false)
	private Integer sensorLDataId;
