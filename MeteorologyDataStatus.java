...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_c",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		,  indexes = @Index(name = "met_idx", columnList = "station_id, parameter_datetime"))
public class MeteorologyDataStatus {

	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_c_id",nullable = false)
