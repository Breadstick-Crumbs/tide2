...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_h",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		, indexes = @Index(name = "leafdata_idx", columnList = "station_id, parameter_datetime"))
public class LeafDataStatus {
	
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_h_id",nullable = false)
	private Integer sensorHDataId;
