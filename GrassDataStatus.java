...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_i",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		, indexes = @Index(name = "grassdata_idx", columnList = "station_id, parameter_datetime"))
public class GrassDataStatus {
	
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_i_id",nullable = false)
	private Integer sensorIDataId;
