...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_k",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})}
		, indexes = @Index(name = "evaporation_idx", columnList = "station_id, parameter_datetime"))
public class EvaporationData {
	
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "sensor_data_k_id",nullable = false)
