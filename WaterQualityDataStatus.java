...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_sensor_data_status_d",uniqueConstraints={@UniqueConstraint(columnNames = {"station_id", "parameter_datetime"})})
public class WaterQualityDataStatus {
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "status_data_d_id",nullable = false)
