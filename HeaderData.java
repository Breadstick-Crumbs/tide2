...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="tems_header_data",uniqueConstraints={@UniqueConstraint(columnNames = {"parameter_stationid", "parameter_datetime"})},
		indexes = @Index(name = "header_idx", columnList = "parameter_stationid, parameter_datetime"))
public class HeaderData{
	@Id
	@GeneratedValue(strategy= GenerationType.IDENTITY)
	@Column(name = "header_data_id")
	private Integer headerDataId;
